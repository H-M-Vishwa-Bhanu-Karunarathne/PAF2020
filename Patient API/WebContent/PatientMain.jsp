        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
	            ...
	            <p class="mb-4"></p>
	            <a href="PatientLogincheck.jsp" class="btn btn-primary py-3 px-4">Patient login</a>
	            <a href="patientreg.jsp" class="btn btn-primary py-3 px-4">Patient Register</a>
	            <a href="patientupdate.jsp" class="btn btn-primary py-3 px-4">Patient Update</a><br><br>
