...
<%
	...
	//Insert item---------------------------------
	if (request.getParameter("ID") != null) { //`ID`,`PName`,`PNIC`,`Pgender`,`PhoneNo`,`Email`,`Address`,`bloodtype`,`Password`
		PatientRegister itemObj = new PatientRegister();
		String stsMsg = itemObj.insertItem(request.getParameter("ID"), request.getParameter("PName"),
		request.getParameter("PNIC"), request.getParameter("Pgender"),request.getParameter("PhoneNo"), request.getParameter("Email"),
		request.getParameter("Address"), request.getParameter("Password"), request.getParameter("bloodtype"));
		...
		<div class="wrapper wrapper--w790">
			<div class="card card-5">
				<div class="card-heading">
					<h2 class="title">Patient Details Update Form</h2>
				</div>
				<div class="card-body">
					<form method="POST" action="docreg.jsp">
						...
						<div class="form-row">
							<div class="name">Pgender</div>
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="text" name="Pgender">
								</div>
							</div>
						</div>
						...
						<div>
							...
							<a class="btn btn-primary" href="patientdet.jsp" role="button">Go
								To Patient Details Page</a>
