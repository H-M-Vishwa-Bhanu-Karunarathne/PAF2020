...
public class patientService {
	...
	public String insertItem(
			...
			{
		String output = phobj.insertItem(Pcode, PName, PNIC,Pgender, PhoneNo,Email,Address,Password);
		return output;
	}
	...
	public String updateItem(String itemData) {
		...
		String Pgender = itemObject.get("Pgender").getAsString();
		String PhoneNo = itemObject.get("PhoneNo").getAsString();
		String Email = itemObject.get("Email").getAsString();
		String Address = itemObject.get("Address").getAsString();
		String Password = itemObject.get("Password").getAsString();
		String output = phobj.updateItem(PID,Pcode, PName, PNIC,Pgender, PhoneNo,Email,Address,Password);
		return output;
	}
